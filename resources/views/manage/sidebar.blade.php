<div class="col-2 pills-col">
    <div class="nav flex-column nav-pills justify-content-center align-items-center w-100 pt-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link active" id="v-pills-flow-tab" data-toggle="pill" href="#v-pills-flow" role="tab" aria-controls="v-pills-flow">Recrutation Flow</a>
        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile">Profile</a>
